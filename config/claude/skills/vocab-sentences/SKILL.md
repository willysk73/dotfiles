...
3.  **Example Sentence**: An original, illustrative sentence using the word in a natural context.
4.  **Korean Translation of Sentence**: The Korean translation of the example sentence.
...
4.  **Content Format**: Use the following Markdown format. Each word should be a level-2 heading. Separate each word's entry with a horizontal rule (`---`).
